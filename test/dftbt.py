...
def main(parameter=None, dataset=None):
    ...
    parameter['CompressionRData'] = '../data/results/ani_result/ani3/compr_20mol_100step_lr_005_comprmin15_dipole.dat'
    ...
    ml['testDataset'] = '../data/dataset/ani02_2000.hdf5'
