...
class ACSF(Descriptor):
    ...
    def create_single(self, system, positions=None):
        ...
        print('neighbours', neighbours, 'indices', indices)
        print(self.get_number_of_features())
    ...
    def get_number_of_features(self):
        ...
        print('wrapper.n_g2:', wrapper.n_g2, 'wrapper.n_g3: ', wrapper.n_g3)
        print('wrapper.n_types:', wrapper.n_types)
        print('wrapper.n_g4:', wrapper.n_g4, 'wrapper.n_g5:', wrapper.n_g5)
        print('wrapper.n_type_pairs', wrapper.n_type_pairs)
